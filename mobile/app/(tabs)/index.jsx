import { View, Text, TouchableOpacity, FlatList, TextComponent, ActivityIndicator, RefreshControl } from 'react-native'
      ...
      <View style={styles.bookCard}>
        ...
        <View style={styles.bookDetails}>
          ...
          <Text style={styles.caption} >{item.caption}</Text>
                    <Text style={styles.date}>Shared on {formatPublichDate(item.createdAt)}</Text>
        </View>
      </View>);
  }
   ...
   ListEmptyComponent={
    ...
    <Ionicons name='book-outline' size={60} color={COLORS.textSecondary} />
      <Text  style={styles.emptyText}>No recommendation yet</Text>
       <Text  style={styles.emptySubtext}>Be the first to share the book!</Text>
      </View>
   }
      />
